...
with DAG (
    dag_id='DAG_STORE_STG__PRODUCTS',
    description='Load data into staging products table',
    ...
    truncate_table = PostgresOperator(
        ...
        sql="""
            truncate table store_stg.stg_products;
            """,
        dag=dag
    )
    ...
    generate_inserts = PythonOperator(
        ...
        op_kwargs={
            ...
            'target_table_name': 'stg_products',
    ...
    load_data = PostgresOperator(
        task_id='load_data',
        postgres_conn_id='postgres_store_db1',
        sql='insert_store_stg__stg_products.sql',
        dag=dag
    )

    wait_data_generation_products = ExternalTaskSensor(
        task_id='wait_data_generation_products',
